...
#+begin_src latex :exports none :file images/latex-example.pdf
\pagecolor{white}
\section*{My Paper}
I just discovered that:
...
*** Markdown math
Inline equations just need single =$=
...
- To :: HTML formats (including HTML(5) slides), via Latex to pdf, MS Word (but support somewhat limited) and OpenOffice formats, various markup formats, and much more
** Scientific workflow
